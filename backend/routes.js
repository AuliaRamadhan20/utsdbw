...
// Middleware untuk filter bad word
const filterBadWord = (req, res, next) => {
    const { body } = req;
    const filteredBody = {};
  
    Object.keys(body).forEach(key => {
      filteredBody[key] = filter.clean(body[key]);
    });
  ...
  // Rute API untuk membuat post
  router.post('/posts', filterBadWord, (req, res) => {
    // kode untuk membuat post
  });
  
  // Rute API untuk mengambil semua post
  router.get('/posts', (req, res) => {
    // kode untuk mengambil semua post
  });
  
  // Rute API untuk mengambil post berdasarkan ID
  router.get('/posts/:id', (req, res) => {
    // kode untuk mengambil post berdasarkan ID
  });
