...
// daftar bad words yang ingin di-filter
const badWords = ['bodoh', 'tolol', 'idiot'];
...
const ChatPage = (props) => {
    ...
    const handleSendText = (e) => {
        ...
        // filter bad words dari pesan
        const filteredText = text.split(' ')
                                  .map(word => badWords.includes(word.toLowerCase()) ? '*'.repeat(word.length) : word)
                                  .join(' ');
